...
<body>
  <div id="wrapper">
        ...
        <div class="row">
          <div class="span4">
            <div class="inner-heading">
              <h2 style="font-size:25px;color:#ffbf00;font-weight:bold ;margin-left:-15% ;">View Customer Feedback</h2>
    ...
    ResultSet rs=st.executeQuery("select * from addfeedbackdata");
    out.println("<table border=3 width=90% >");
    		  
    out.println("<tr>");
    out.println("<th>"+"No"+"</th>"+"<th>"+"Email"+"</th>"+"<th>"+"ProductId"+"</th>"+"<th>"+"Comment"+"</th>"+"<th>"+"Rating"+"</th>");

    out.println("</tr>");
    while(rs.next()){
        out.println("<tr>");
        out.println("<td>"+rs.getInt(1)+"</td>"+"<td>"+rs.getString(2)+"</td>"+"<td>"+rs.getInt(3)+"</td>"+"<td>"+rs.getString(4)+"</td>"+"<td>"+rs.getInt(5)+"</td>");
