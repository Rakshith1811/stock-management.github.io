    ...
    <header>
        ...
        <div class="row">
          <div class="span4">
            <div class="logo">
              <a href="index.jsp">
              <h1 style="font-size:35px;color:#F03C02;font-weight:bold;margin-left:8%">Stock Management System</h1>
			  </a>
            </div>
          </div>
          <div class="span8">
                  ...
                  <ul class="nav topnav">
                    <li class=" active">
                      <a href="">Home </a>
                             ...
                             <li><a href="adminloginpage.jsp">Admin Page</a></li>
          ...
          <div class="row" >
            <div class="span12" >
              ...
              <div class="nivo-caption" id="caption-3">
                ...
                <div>
                  <h2>Stock  <strong>Management</strong></h2>
                  <p>
                    Lorem ipsum dolor sit amet nsectetuer nec Vivamus. Curabitu laoreet amet eget. Viurab oremd ellentesque ameteget. Lorem ipsum dolor sit amet nsectetuer nec vivamus.
                  </p>
                  <a href="#" class="btn btn-theme">Read More</a>
