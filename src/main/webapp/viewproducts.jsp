...
<body>
  <div id="wrapper">
    ...
    <section id="inner-headline">
      <div class="container">
        <div class="row">
          ...
          <h2 style="font-size:25px;color:#ffbf00;font-weight:bold ;margin-left:-15% ;">View Products</h2>
    ...
    out.println("<tr>");
    out.println("<th>"+"Id"+"</th>"+"<th>"+"Category"+"</th>"+"<th>"+"Title"+"</th>"+"<th>"+"Description"+"</th>"+"<th>"+"Cost"+"</th>"+"<th>"+"Quantity"+"</th>"+"<th>"+"Stock"+"</th>"+"<th>"+"Product Status"+"</th>"+"<th>"+"TotalCost"+"</th>"+"<th>"+"Buy"+"</th>");

    out.println("</tr>");
    while(rs.next()){
        out.println("<tr>");
       //out.println("<td style='text-align:center'</td>");
        out.println("<td>"+rs.getInt(1)+"</td>"+"<td>"+rs.getString(2)+"</td>"+"<td>"+rs.getString(3)+"</td>"+"<td>"+rs.getString(4)+"</td>"+"<td>"+rs.getDouble(5)+"</td>"+"<td>"+rs.getInt(6)+"</td>"+"<td>"+rs.getString(7)+"</td>"+"<td>"+rs.getString(8)+"</td>"+"<td>"+rs.getDouble(9)+"</td>");
