        ...
        <div class="row">
          <div class="span4">
            <div class="inner-heading">
              <h2 style="font-size:25px;color:#ffbf00;font-weight:bold ;margin-left:-15% ;">Custmer Edit</h2>
                    	...
                    	%>
                    	            ...
                    	            <form action="editdata.jsp" method="post">
                    	              ...
                    	              <div class="col-lg-50">
                    	                ...
                    	                <div class="col-lg-8">
                    	                  <input type="text" name="name" class="form-control" id="name"  placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" value="<%=rs.getString(2) %>" />
                    	                  <div class="validation"></div>
                    	                </div>
                    	                ...
                    	                <div class="col-lg-8">
                    	                  ...
                    	                  <div class="col-lg-8">
                                             <textarea name="address" id="address" placeholder="Enter Address" data-rule="minlen:3" data-msg="Please Address" value="<%=rs.getString(5) %>" ></textarea>
                
                                        <div class="validation"></div>
                                         </div>
                                 <div class="col-lg-8">
                                <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Mobile" data-rule="minlen:4" data-msg="Please enter a valid Mobile" value="<%=rs.getString(6) %>"/>
                               <div class="validation"></div>
                                     </div>
